  ...
  $("#redeemFromBtn").click(function () {
    ...
    if (redeem.from == "multisigAddress") {
      $("#redeemFromStatus")
        .removeClass("hidden")
        .html(
          '<span class="glyphicon glyphicon-exclamation-sign"></span> You should use the redeem script, not its address!'
        );
      return false;
    }
    ...
    if (redeem.from == "txid") {
      tx.getTransaction(redeem.addr, function (data) {
        $("#redeemFromAddress")
          .removeClass("hidden")
          .html(
            '<span class="glyphicon glyphicon-info-sign"></span> Attempted to rebuild transaction id <a href="' +
              explorer_tx +
              redeem.addr +
              '" target="_blank">' +
              redeem.addr +
