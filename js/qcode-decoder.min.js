!(function (e, t) {
  ...
  function t(e, t, r) {
    (this.ecCodewordsPerBlock = e),
      (this.ecBlocks = r ? new Array(t, r) : new Array(t)),
  ...
  function r(e, t, r, n, i, o) {
    (this.versionNumber = e),
      ...
      (this.ecBlocks = new Array(r, n, i, o));
    for (
      var a = 0, s = r.ECCodewordsPerBlock, h = r.getECBlocks(), w = 0;
      w < h.length;
      w++
    ) {
      var f = h[w];
    ...
    (this.totalCodewords = a),
      ...
      (this.buildFunctionPattern = function () {
        ...
        for (var r = this.alignmentPatternCenters.length, n = 0; r > n; n++)
          for (var i = this.alignmentPatternCenters[n] - 2, o = 0; r > o; o++)
            (0 == n && (0 == o || o == r - 1)) ||
              (n == r - 1 && 0 == o) ||
  ...
  function n() {
    return new Array(
      ...
      new r(
        5,
        new Array(6, 30),
        new t(26, new e(1, 108)),
        new t(24, new e(2, 43)),
        new t(18, new e(2, 15), new e(2, 16)),
        new t(22, new e(2, 11), new e(2, 12))
      ),
      new r(
        6,
        new Array(6, 34),
      ...
      new r(
        ...
        new t(20, new e(2, 78)),
        new t(18, new e(4, 31)),
        new t(18, new e(2, 14), new e(4, 15)),
        new t(26, new e(4, 13), new e(1, 14))
      ),
      new r(
        8,
        new Array(6, 24, 42),
        new t(24, new e(2, 97)),
        new t(22, new e(2, 38), new e(2, 39)),
        new t(22, new e(4, 18), new e(2, 19)),
        new t(26, new e(4, 14), new e(2, 15))
      ),
      new r(
        9,
        new Array(6, 26, 46),
        new t(30, new e(2, 116)),
        new t(22, new e(3, 36), new e(2, 37)),
        new t(20, new e(4, 16), new e(4, 17)),
        new t(24, new e(4, 12), new e(4, 13))
      ),
      new r(
        10,
        new Array(6, 28, 50),
        new t(18, new e(2, 68), new e(2, 69)),
        new t(26, new e(4, 43), new e(1, 44)),
        new t(24, new e(6, 19), new e(2, 20)),
        new t(28, new e(6, 15), new e(2, 16))
      ),
      new r(
        11,
        new Array(6, 30, 54),
        new t(20, new e(4, 81)),
        new t(30, new e(1, 50), new e(4, 51)),
        new t(28, new e(4, 22), new e(4, 23)),
        new t(24, new e(3, 12), new e(8, 13))
      ),
      new r(
        12,
        new Array(6, 32, 58),
        new t(24, new e(2, 92), new e(2, 93)),
        new t(22, new e(6, 36), new e(2, 37)),
        new t(26, new e(4, 20), new e(6, 21)),
        new t(28, new e(7, 14), new e(4, 15))
      ),
      new r(
        13,
        new Array(6, 34, 62),
        new t(26, new e(4, 107)),
        new t(22, new e(8, 37), new e(1, 38)),
        new t(24, new e(8, 20), new e(4, 21)),
        new t(22, new e(12, 11), new e(4, 12))
      ),
      new r(
        14,
        new Array(6, 26, 46, 66),
        new t(30, new e(3, 115), new e(1, 116)),
        new t(24, new e(4, 40), new e(5, 41)),
        new t(20, new e(11, 16), new e(5, 17)),
        new t(24, new e(11, 12), new e(5, 13))
      ),
      new r(
        15,
        new Array(6, 26, 48, 70),
        new t(22, new e(5, 87), new e(1, 88)),
        new t(24, new e(5, 41), new e(5, 42)),
        new t(30, new e(5, 24), new e(7, 25)),
        new t(24, new e(11, 12), new e(7, 13))
      ),
      new r(
        16,
        new Array(6, 26, 50, 74),
        new t(24, new e(5, 98), new e(1, 99)),
        new t(28, new e(7, 45), new e(3, 46)),
        new t(24, new e(15, 19), new e(2, 20)),
        new t(30, new e(3, 15), new e(13, 16))
      ),
      new r(
        17,
        new Array(6, 30, 54, 78),
        new t(28, new e(1, 107), new e(5, 108)),
        new t(28, new e(10, 46), new e(1, 47)),
        new t(28, new e(1, 22), new e(15, 23)),
        new t(28, new e(2, 14), new e(17, 15))
      ),
      new r(
        18,
        new Array(6, 30, 56, 82),
        new t(30, new e(5, 120), new e(1, 121)),
        new t(26, new e(9, 43), new e(4, 44)),
        new t(28, new e(17, 22), new e(1, 23)),
        new t(28, new e(2, 14), new e(19, 15))
      ),
      new r(
        19,
        new Array(6, 30, 58, 86),
        new t(28, new e(3, 113), new e(4, 114)),
        new t(26, new e(3, 44), new e(11, 45)),
        new t(26, new e(17, 21), new e(4, 22)),
        new t(26, new e(9, 13), new e(16, 14))
      ),
      new r(
        20,
        new Array(6, 34, 62, 90),
        new t(28, new e(3, 107), new e(5, 108)),
        new t(26, new e(3, 41), new e(13, 42)),
        new t(30, new e(15, 24), new e(5, 25)),
        new t(28, new e(15, 15), new e(10, 16))
      ),
      new r(
        21,
        new Array(6, 28, 50, 72, 94),
        new t(28, new e(4, 116), new e(4, 117)),
        new t(26, new e(17, 42)),
        new t(28, new e(17, 22), new e(6, 23)),
        new t(30, new e(19, 16), new e(6, 17))
      ),
      new r(
        22,
        new Array(6, 26, 50, 74, 98),
        new t(28, new e(2, 111), new e(7, 112)),
        new t(28, new e(17, 46)),
        new t(30, new e(7, 24), new e(16, 25)),
        new t(24, new e(34, 13))
      ),
      new r(
        23,
        new Array(6, 30, 54, 74, 102),
        new t(30, new e(4, 121), new e(5, 122)),
        new t(28, new e(4, 47), new e(14, 48)),
        new t(30, new e(11, 24), new e(14, 25)),
        new t(30, new e(16, 15), new e(14, 16))
      ),
      new r(
        24,
        new Array(6, 28, 54, 80, 106),
        new t(30, new e(6, 117), new e(4, 118)),
        new t(28, new e(6, 45), new e(14, 46)),
        new t(30, new e(11, 24), new e(16, 25)),
        new t(30, new e(30, 16), new e(2, 17))
      ),
      new r(
        25,
        new Array(6, 32, 58, 84, 110),
        new t(26, new e(8, 106), new e(4, 107)),
        new t(28, new e(8, 47), new e(13, 48)),
        new t(30, new e(7, 24), new e(22, 25)),
        new t(30, new e(22, 15), new e(13, 16))
      ),
      new r(
        26,
        new Array(6, 30, 58, 86, 114),
        new t(28, new e(10, 114), new e(2, 115)),
        new t(28, new e(19, 46), new e(4, 47)),
        new t(28, new e(28, 22), new e(6, 23)),
        new t(30, new e(33, 16), new e(4, 17))
      ),
      new r(
        27,
        new Array(6, 34, 62, 90, 118),
        new t(30, new e(8, 122), new e(4, 123)),
        new t(28, new e(22, 45), new e(3, 46)),
        new t(30, new e(8, 23), new e(26, 24)),
        new t(30, new e(12, 15), new e(28, 16))
      ),
      new r(
        28,
        new Array(6, 26, 50, 74, 98, 122),
        new t(30, new e(3, 117), new e(10, 118)),
        new t(28, new e(3, 45), new e(23, 46)),
        new t(30, new e(4, 24), new e(31, 25)),
        new t(30, new e(11, 15), new e(31, 16))
      ),
      new r(
        29,
        new Array(6, 30, 54, 78, 102, 126),
        new t(30, new e(7, 116), new e(7, 117)),
        new t(28, new e(21, 45), new e(7, 46)),
        new t(30, new e(1, 23), new e(37, 24)),
        new t(30, new e(19, 15), new e(26, 16))
      ),
      new r(
        30,
        new Array(6, 26, 52, 78, 104, 130),
        new t(30, new e(5, 115), new e(10, 116)),
        new t(28, new e(19, 47), new e(10, 48)),
        new t(30, new e(15, 24), new e(25, 25)),
        new t(30, new e(23, 15), new e(25, 16))
      ),
      new r(
        31,
        new Array(6, 30, 56, 82, 108, 134),
        new t(30, new e(13, 115), new e(3, 116)),
        new t(28, new e(2, 46), new e(29, 47)),
        new t(30, new e(42, 24), new e(1, 25)),
        new t(30, new e(23, 15), new e(28, 16))
      ),
      new r(
        32,
        new Array(6, 34, 60, 86, 112, 138),
        new t(30, new e(17, 115)),
        new t(28, new e(10, 46), new e(23, 47)),
        new t(30, new e(10, 24), new e(35, 25)),
        new t(30, new e(19, 15), new e(35, 16))
      ),
      new r(
        33,
        new Array(6, 30, 58, 86, 114, 142),
        new t(30, new e(17, 115), new e(1, 116)),
        new t(28, new e(14, 46), new e(21, 47)),
        new t(30, new e(29, 24), new e(19, 25)),
        new t(30, new e(11, 15), new e(46, 16))
      ),
      new r(
        34,
        new Array(6, 34, 62, 90, 118, 146),
        new t(30, new e(13, 115), new e(6, 116)),
        new t(28, new e(14, 46), new e(23, 47)),
        new t(30, new e(44, 24), new e(7, 25)),
        new t(30, new e(59, 16), new e(1, 17))
      ),
      new r(
        35,
        new Array(6, 30, 54, 78, 102, 126, 150),
        new t(30, new e(12, 121), new e(7, 122)),
        new t(28, new e(12, 47), new e(26, 48)),
        new t(30, new e(39, 24), new e(14, 25)),
        new t(30, new e(22, 15), new e(41, 16))
      ),
      new r(
        36,
        new Array(6, 24, 50, 76, 102, 128, 154),
        new t(30, new e(6, 121), new e(14, 122)),
        new t(28, new e(6, 47), new e(34, 48)),
        new t(30, new e(46, 24), new e(10, 25)),
        new t(30, new e(2, 15), new e(64, 16))
      ),
      new r(
        37,
        new Array(6, 28, 54, 80, 106, 132, 158),
        new t(30, new e(17, 122), new e(4, 123)),
        new t(28, new e(29, 46), new e(14, 47)),
        new t(30, new e(49, 24), new e(10, 25)),
        new t(30, new e(24, 15), new e(46, 16))
      ),
      new r(
        38,
        new Array(6, 32, 58, 84, 110, 136, 162),
        new t(30, new e(4, 122), new e(18, 123)),
        new t(28, new e(13, 46), new e(32, 47)),
        new t(30, new e(48, 24), new e(14, 25)),
        new t(30, new e(42, 15), new e(32, 16))
      ),
      new r(
        39,
        new Array(6, 26, 54, 82, 110, 138, 166),
        new t(30, new e(20, 117), new e(4, 118)),
        new t(28, new e(40, 47), new e(7, 48)),
        new t(30, new e(43, 24), new e(22, 25)),
        new t(30, new e(10, 15), new e(67, 16))
      ),
      new r(
        40,
        new Array(6, 30, 58, 86, 114, 142, 170),
        new t(30, new e(19, 118), new e(6, 119)),
        new t(28, new e(18, 47), new e(31, 48)),
        new t(30, new e(34, 24), new e(34, 25)),
        new t(30, new e(20, 15), new e(61, 16))
      )
    );
  }
    ...
    (this.a11 = e),
      ...
      (this.transformPoints2 = function (e, t) {
        for (var r = e.length, n = 0; r > n; n++) {
          ...
          (e[n] = (this.a11 * i + this.a21 * o + this.a31) / a),
            (t[n] = (this.a12 * i + this.a22 * o + this.a32) / a);
        }
      }),
  ...
  function a(e) {
    (this.image = e),
      ...
      (this.sizeOfBlackWhiteBlackRun = function (e, t, r, n) {
      ...
      (this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, r, n) {
        ...
        0 > a
          ? ((o = e / (e - a)), (a = 0))
          : a >= qrcode.width &&
            ((o = (qrcode.width - 1 - e) / (a - e)), (a = qrcode.width - 1));
      ...
      (this.createTransform = function (e, t, r, n, o) {
        ...
        null != n
          ? ((a = n.X), (s = n.Y), (h = d = w - 3))
          : ((a = t.X - e.X + r.X), (s = t.Y - e.Y + r.Y), (h = d = w));
        var f = i.quadrilateralToQuadrilateral(
          3.5,
          3.5,
          w,
          3.5,
        ...
        if (h.AlignmentPatternCenters.length > 0)
          for (
            var f = n.X - t.X + i.X,
              c = n.Y - t.Y + i.Y,
              u = 1 - 3 / d,
              l = Math.floor(t.X + u * (f - t.X)),
              v = Math.floor(t.Y + u * (c - t.Y)),
              g = 4;
            16 >= g;
            g <<= 1
          ) {
            w = this.findAlignmentInRegion(a, l, v, g);
            break;
          }
        var m,
          y = this.createTransform(t, n, i, w, s),
          p = this.sampleGrid(this.image, y, s);
        return (
          (m = null == w ? new Array(i, t, n) : new Array(i, t, n, w)),
          new o(p, m)
        );
      }),
  ...
  function s(e) {
    (this.errorCorrectionLevel = h.forBits((e >> 3) & 3)),
      (this.dataMask = 7 & e),
  ...
  function d(e, t) {
    ...
    this.__defineGetter__("Width", function () {
      ...
      (this.setRegion = function (e, t, r, n) {
        ...
        for (var a = t; o > a; a++)
          for (var s = a * this.rowSize, h = e; i > h; h++)
    ...
    (this.bitMatrix = e),
      ...
      (this.readCodewords = function () {
        ...
        for (
          ...
          6 == w && w--;
          for (var f = 0; n > f; f++)
            for (var c = o ? n - 1 - f : f, u = 0; 2 > u; u++)
              i.get_Renamed(w - u, c) ||
                (d++,
                (h <<= 1),
                this.bitMatrix.get_Renamed(w - u, c) && (h |= 1),
                8 == d && ((a[s++] = h), (d = 0), (h = 0)));
          o ^= !0;
        }
  ...
  function C(e) {
    (this.field = e),
      (this.decode = function (e, t) {
        for (
          var r = new M(this.field, e), n = new Array(t), i = 0;
          i < n.length;
          i++
        )
          n[i] = 0;
        ...
        if (!a)
          for (
            var h = new M(this.field, n),
              ...
              w = d[0],
              f = d[1],
              c = this.findErrorLocations(w),
              u = this.findErrorMagnitudes(f, c, o),
              i = 0;
            i < c.length;
            i++
          ) {
            var l = e.length - 1 - this.field.log(c[i]);
            if (0 > l) throw "ReedSolomonException Bad error location";
            e[l] = _.addOrSubtract(e[l], u[i]);
          }
      }),
      (this.runEuclideanAlgorithm = function (e, t, r) {
        ...
        for (
          ...
          o = w;
          for (
            var u = this.field.Zero,
              l = i.getCoefficient(i.Degree),
              v = this.field.inverse(l);
            o.Degree >= i.Degree && !o.Zero;

          ) {
            var g = o.Degree - i.Degree,
              m = this.field.multiply(o.getCoefficient(o.Degree), v);
            (u = u.addOrSubtract(this.field.buildMonomial(g, m))),
              (o = o.addOrSubtract(i.multiplyByMonomial(g, m)));
          }
          (s = u.multiply1(a).addOrSubtract(f)),
            (d = u.multiply1(h).addOrSubtract(c));
        }
        var y = d.getCoefficient(0);
      ...
      (this.findErrorLocations = function (e) {
        ...
        for (var r = new Array(t), n = 0, i = 1; 256 > i && t > n; i++)
      ...
      (this.findErrorMagnitudes = function (e, t, r) {
        for (var n = t.length, i = new Array(n), o = 0; n > o; o++) {
          for (var a = this.field.inverse(t[o]), s = 1, h = 0; n > h; h++)
            o != h &&
              (s = this.field.multiply(
                s,
                _.addOrSubtract(1, this.field.multiply(t[h], a))
              ));
          (i[o] = this.field.multiply(e.evaluateAt(a), this.field.inverse(s))),
            r && (i[o] = this.field.multiply(i[o], a));
        }
        return i;
      });
  }
  function M(e, t) {
    ...
    this.__defineGetter__("Zero", function () {
      ...
      (this.evaluateAt = function (e) {
        ...
        if (1 == e) {
          for (var r = 0, n = 0; t > n; n++)
            r = _.addOrSubtract(r, this.coefficients[n]);
          return r;
        }
        for (var i = this.coefficients[0], n = 1; t > n; n++)
          i = _.addOrSubtract(this.field.multiply(e, i), this.coefficients[n]);
        return i;
      }),
      (this.addOrSubtract = function (t) {
        ...
        for (
          var o = new Array(n.length), a = n.length - r.length, s = 0;
          a > s;
          s++
        )
          o[s] = n[s];
        for (var h = a; h < n.length; h++)
          o[h] = _.addOrSubtract(r[h - a], n[h]);
        return new M(e, o);
      }),
      (this.multiply1 = function (e) {
        ...
        for (
          ...
          for (var s = t[a], h = 0; i > h; h++)
            o[a + h] = _.addOrSubtract(o[a + h], this.field.multiply(s, n[h]));
      ...
      (this.multiply2 = function (e) {
        ...
        if (1 == e) return this;
        for (
          var t = this.coefficients.length, r = new Array(t), n = 0;
          t > n;
          n++
        )
      ...
      (this.multiplyByMonomial = function (e, t) {
        ...
        for (
          var r = this.coefficients.length, n = new Array(r + e), i = 0;
          i < n.length;
          i++
        )
          n[i] = 0;
      ...
      (this.divide = function (e) {
        ...
        for (
          var t = this.field.Zero,
            r = this,
            n = e.getCoefficient(e.Degree),
            i = this.field.inverse(n);
          r.Degree >= e.Degree && !r.Zero;
  ...
  function S() {
    (this.image = null),
      ...
      (this.foundPatternCross = function (e) {
        ...
        if (7 > t) return !1;
        var i = Math.floor((t << L) / 7),
          o = Math.floor(i / 2);
        return (
          Math.abs(i - (e[0] << L)) < o &&
          Math.abs(i - (e[1] << L)) < o &&
          Math.abs(3 * i - (e[2] << L)) < 3 * o &&
          Math.abs(i - (e[3] << L)) < o &&
          Math.abs(i - (e[4] << L)) < o
        );
      }),
      ...
      (this.handlePossibleCenter = function (e, t, r) {
        ...
        if (
          ...
          for (
            var a = n / 7, s = !1, h = this.possibleCenters.length, d = 0;
            h > d;
            d++
          ) {
      ...
      (this.selectBestPatterns = function () {
        ...
        if (e > 3) {
          ...
          for (
            var a = Math.sqrt(r / e - o * o), s = Math.max(0.2 * o, a), n = 0;
            n < this.possibleCenters.length && this.possibleCenters.length > 3;
            n++
          ) {
            var h = this.possibleCenters[n];
            Math.abs(h.EstimatedModuleSize - o) > s &&
      ...
      (this.haveMultiplyConfirmedCenters = function () {
        for (
          var e = 0, t = 0, r = this.possibleCenters.length, n = 0;
          r > n;
          n++
        ) {
          var i = this.possibleCenters[n];
          i.Count >= O && (e++, (t += i.EstimatedModuleSize));
        }
        if (3 > e) return !1;
        for (var o = t / r, a = 0, n = 0; r > n; n++)
      ...
      (this.findFinderPattern = function (e) {
                ...
                if (this.foundPatternCross(a)) {
                  ...
                  if (w)
                    if (((i = 2), this.hasSkipped))
                      ...
                      f > a[2] && ((s += f - a[2] - i), (d = n - 1));
                    }
                  else {
                    do d++;
                    while (n > d && !e[d + s * qrcode.width]);
                    d--;
                  }
                  (h = 0),
                    (a[0] = 0),
        ...
        return qrcode.orderBestPatterns(c), new k(c);
      });
  }
  function E(e, t, r) {
    (this.x = e),
    ...
    (this.image = e),
      ...
      (this.crossCheckVertical = function (e, t, r, n) {
        var i = this.image,
          ...
          a = this.crossCheckStateCount;
        (a[0] = 0), (a[1] = 0), (a[2] = 0);
        for (var s = e; s >= 0 && i[t + s * qrcode.width] && a[1] <= r; )
          a[1]++, s--;
        if (0 > s || a[1] > r) return 0 / 0;
        for (; s >= 0 && !i[t + s * qrcode.width] && a[0] <= r; ) a[0]++, s--;
        if (a[0] > r) return 0 / 0;
        for (s = e + 1; o > s && i[t + s * qrcode.width] && a[1] <= r; )
          a[1]++, s++;
      ...
      (this.find = function () {
        for (
            ...
            if (e[w + d * qrcode.width])
              if (1 == f) s[f]++;
                ...
                if (this.foundPatternCross(s)) {
                  var c = this.handlePossibleCenter(s, d, w);
                  if (null != c) return c;
                }
          ...
          if (this.foundPatternCross(s)) {
            var c = this.handlePossibleCenter(s, d, o);
            if (null != c) return c;
          }
        }
    ...
    (this.blockPointer = 0),
      ...
      (this.getNextBits = function (e) {
        ...
        if (e < this.bitPointer + 1 + 16) {
          for (var i = 0, o = 0, n = 0; n < this.bitPointer + 1; n++)
            i += 1 << n;
          var a =
          ...
          var h =
            (this.blocks[this.blockPointer] & o) >>
      ...
      (this.getFigureString = function (e) {
        ...
        do
          t >= 3
            ? ((r = this.getNextBits(10)),
              100 > r && (n += "0"),
              10 > r && (n += "0"),
              (t -= 3))
            : 2 == t
            ? ((r = this.getNextBits(7)), 10 > r && (n += "0"), (t -= 2))
            : 1 == t && ((r = this.getNextBits(4)), (t -= 1)),
            (n += r);
        while (t > 0);
        return n;
      }),
      (this.get8bitByteArray = function (e) {
        var t = e,
          r = 0,
          n = new Array();
        do (r = this.getNextBits(8)), n.push(r), t--;
        while (t > 0);
        return n;
      }),
      (this.getKanjiString = function (e) {
        ...
        do {
          ...
          var i = r % 192,
            ...
            a = (o << 8) + i,
            s = 0;
          (s = 40956 >= a + 33088 ? a + 33088 : a + 49472),
      ...
      this.__defineGetter__("DataByte", function () {
        for (var e = new Array(), t = 1, r = 2, n = 4, i = 8; ; ) {
          ...
          if (((dataLength = this.getDataLength(o)), 1 > dataLength))
            throw "Invalid data length: " + dataLength;
          switch (o) {
            case t:
              for (
                var a = this.getFigureString(dataLength),
            ...
            case r:
              for (
                var a = this.getRomanAndFigureString(dataLength),
                  s = new Array(a.length),
                  h = 0;
                h < a.length;
                h++
  ...
  (GridSampler = {}),
    (GridSampler.checkAndNudgePoints = function (e, t) {
      for (
        var r = qrcode.width, n = qrcode.height, i = !0, o = 0;
        o < t.length && i;
        o += 2
      ) {
    ...
    (GridSampler.sampleGrid3 = function (e, t, r) {
      for (var n = new d(t), i = new Array(t << 1), o = 0; t > o; o++) {
        for (var a = i.length, s = o + 0.5, h = 0; a > h; h += 2)
          (i[h] = (h >> 1) + 0.5), (i[h + 1] = s);
        r.transformPoints1(i), GridSampler.checkAndNudgePoints(e, i);
        try {
          for (var h = 0; a > h; h += 2) {
            var w =
                4 * Math.floor(i[h]) + Math.floor(i[h + 1]) * qrcode.width * 4,
              f = e[Math.floor(i[h]) + qrcode.width * Math.floor(i[h + 1])];
            (qrcode.imagedata.data[w] = f ? 255 : 0),
              (qrcode.imagedata.data[w + 1] = f ? 255 : 0),
              (qrcode.imagedata.data[w + 2] = 0),
              (qrcode.imagedata.data[w + 3] = 255),
              f && n.set_Renamed(h >> 1, o);
          }
        } catch (c) {
          throw "Error.checkAndNudgePoints";
        }
    ...
    (GridSampler.sampleGridx = function (
      ...
      var p = i.quadrilateralToQuadrilateral(
        r,
        n,
        o,
        a,
      ...
      return GridSampler.sampleGrid3(e, t, p);
    }),
    ...
    (i.quadrilateralToQuadrilateral = function (
      ...
      var g = this.quadrilateralToSquare(e, t, r, n, i, o, a, s),
        m = this.squareToQuadrilateral(h, d, w, f, c, u, l, v);
      return m.times(g);
    }),
    (i.squareToQuadrilateral = function (e, t, r, n, o, a, s, h) {
      return (
        ...
        (dy3 = t - n + a - h),
        0 == dy2 && 0 == dy3
          ? new i(r - e, o - r, e, n - t, a - n, t, 0, 0, 1)
          : ((dx1 = r - o),
            (dx2 = s - o),
            (dx3 = e - r + o - s),
            (dy1 = n - a),
  ...
  var x = 21522,
    ...
    F = new Array(0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4);
  (s.numBitsDiffering = function (e, t) {
    ...
    (s.decodeFormatInformation = function (e) {
      ...
      return null != t ? t : s.doDecodeFormatInformation(e ^ x);
    }),
    (s.doDecodeFormatInformation = function (e) {
      for (var t = 4294967295, r = 0, n = 0; n < B.length; n++) {
        var i = B[n],
          o = i[0];
    ...
    (h.forBits = function (e) {
      if (0 > e || e >= R.length) throw "ArgumentException";
      return R[e];
    });
  var G = new h(0, 1, "L"),
    I = new h(1, 0, "M"),
  ...
  (w.getDataBlocks = function (e, t, r) {
    ...
    for (
      var n = t.getECBlocksForLevel(r), i = 0, o = n.getECBlocks(), a = 0;
      a < o.length;
      a++
    )
      i += o[a].Count;
    for (var s = new Array(i), h = 0, d = 0; d < o.length; d++)
      for (var f = o[d], a = 0; a < f.Count; a++) {
        var c = f.DataCodewords,
          u = n.ECCodewordsPerBlock + c;
        s[h++] = new w(c, new Array(u));
      }
    for (var l = s[0].codewords.length, v = s.length - 1; v >= 0; ) {
      var g = s[v].codewords.length;
      if (g == l) break;
      v--;
    }
    v++;
    for (var m = l - n.ECCodewordsPerBlock, y = 0, a = 0; m > a; a++)
      for (var d = 0; h > d; d++) s[d].codewords[a] = e[y++];
    for (var d = v; h > d; d++) s[d].codewords[m] = e[y++];
    for (var p = s[0].codewords.length, a = m; p > a; a++)
      for (var d = 0; h > d; d++) {
        var b = v > d ? a : a + 1;
        s[d].codewords[b] = e[y++];
      }
    ...
    (Decoder = {}),
    (Decoder.rsDecoder = new C(_.QR_CODE_FIELD)),
    ...
    (Decoder.decode = function (e) {
      for (
        var t = new f(e),
          r = t.readVersion(),
          n = t.readFormatInformation().ErrorCorrectionLevel,
          i = t.readCodewords(),
          o = w.getDataBlocks(i, r, n),
          a = 0,
          s = 0;
        s < o.length;
        s++
      ...
      for (var h = new Array(a), d = 0, c = 0; c < o.length; c++) {
        var u = o[c],
          l = u.Codewords,
          v = u.NumDataCodewords;
        Decoder.correctErrors(l, v);
        for (var s = 0; v > s; s++) h[d++] = l[s];
      }
      var g = new D(h, r.VersionNumber, n.Bits);
      return g;
    }),
    (qrcode = {}),
    ...
    (qrcode.setCanvasElement = function (e) {
      ...
      (i.onload = function () {
        ...
        try {
          ...
          (qrcode.result = "Error decoding QR Code from Image"),
            t(new Error("Error decoding QR Code from Image"));
        }
        null != qrcode.callback && qrcode.callback(qrcode.result);
      }),
        (i.src = e);
    ...
    (qrcode.process = function (e) {
      var t =
        (new Date().getTime(), qrcode.grayScaleToBitmap(qrcode.grayscale()));
      if (qrcode.debug) {
        for (var r = 0; r < qrcode.height; r++)
          for (var n = 0; n < qrcode.width; n++) {
            var i = 4 * n + r * qrcode.width * 4;
            (qrcode.imagedata.data[i] = t[n + r * qrcode.width] ? 0 : 0),
              (qrcode.imagedata.data[i + 1] = t[n + r * qrcode.width] ? 0 : 0),
              (qrcode.imagedata.data[i + 2] = t[n + r * qrcode.width]
                ? 255
                : 0);
          }
      ...
      for (
        var h = Decoder.decode(s.bits), d = h.DataByte, w = "", f = 0;
        f < d.length;
        f++
      )
        for (var c = 0; c < d[f].length; c++) w += String.fromCharCode(d[f][c]);
      new Date().getTime();
    ...
    (qrcode.binarize = function (e) {
      for (
        var t = new Array(qrcode.width * qrcode.height), r = 0;
        r < qrcode.height;
        r++
      )
        for (var n = 0; n < qrcode.width; n++) {
    ...
    (qrcode.getMiddleBrightnessPerArea = function (e) {
      for (
        var t = 4,
          r = Math.floor(qrcode.width / t),
          n = Math.floor(qrcode.height / t),
          i = new Array(t),
          o = 0;
        t > o;
        o++
      ...
      for (var s = 0; t > s; s++)
        for (var h = 0; t > h; h++) {
          ...
          for (var d = 0; n > d; d++)
            for (var w = 0; r > w; w++) {
              var f = e[r * h + w + (n * s + d) * qrcode.width];
              f < i[h][s][0] && (i[h][s][0] = f),
                f > i[h][s][1] && (i[h][s][1] = f);
            }
        }
      for (var c = new Array(t), u = 0; t > u; u++) c[u] = new Array(t);
      for (var s = 0; t > s; s++)
        for (var h = 0; t > h; h++)
          c[h][s] = Math.floor((i[h][s][0] + i[h][s][1]) / 2);
      return c;
    }),
    (qrcode.grayScaleToBitmap = function (e) {
      for (
        var t = qrcode.getMiddleBrightnessPerArea(e),
          r = t.length,
          n = Math.floor(qrcode.width / r),
          i = Math.floor(qrcode.height / r),
          o = new Array(qrcode.height * qrcode.width),
          a = 0;
        r > a;
        a++
      )
        for (var s = 0; r > s; s++)
          for (var h = 0; i > h; h++)
            for (var d = 0; n > d; d++)
              o[n * s + d + (i * a + h) * qrcode.width] =
                e[n * s + d + (i * a + h) * qrcode.width] < t[s][a] ? !0 : !1;
      return o;
    }),
    (qrcode.grayscale = function () {
      for (
        var e = new Array(qrcode.width * qrcode.height), t = 0;
        t < qrcode.height;
        t++
      )
    ...
    (Array.prototype.remove = function (e, t) {
      ...
      return (
        (this.length = 0 > e ? this.length + e : e), this.push.apply(this, r)
      );
    });
  var z = 3,
    V = 57,
  ...
  (function (e, t) {
    "function" == typeof define && define.amd
      ? define(["qrcode"], t)
      : "object" == typeof exports
      ? (module.exports = t(require("../build/qrcode")))
      : (e.QCodeDecoder = t(qrcode));
  })(this, function (e) {
    "use strict";
    function t() {
      return this instanceof t
        ? ((this.timerCapture = null),
          ...
          (this.stream = null),
          (this.videoConstraints = { video: !0, audio: !1 }),
          void 0)
        : new t();
    }
    return (
      ...
      (t.prototype._prepareCanvas = function (t) {
        return (
          this.canvasElem ||
            ...
            (this.canvasElem.style.width = t.videoWidth + "px"),
            (this.canvasElem.style.height = t.videoHeight + "px"),
            (this.canvasElem.width = t.videoWidth),
            (this.canvasElem.height = t.videoHeight)),
          e.setCanvasElement(this.canvasElem),
          this
        );
      }),
      (t.prototype._captureToCanvas = function (t, r, n) {
        if (
          ...
          i.clearRect(0, 0, t.videoWidth, t.videoHeight),
      ...
      (t.prototype.decodeFromCamera = function (e, t, r) {
        ...
        return (
          this.hasGetUserMedia() ||
            t(new Error("Couldn't get video from camera")),
          navigator.getUserMedia(
      ...
      (t.prototype.decodeFromImage = function (t, r) {
        if (+t.nodeType > 0 && !t.src)
          throw new Error("The ImageElement must contain a src");
        return (t = t.src ? t.src : t), e.decode(t, r), this;
      }),
      (t.prototype.stop = function () {
        return (
          this.stream && (this.stream.stop(), (this.stream = void 0)),
          this.timerCapture &&
            (clearTimeout(this.timerCapture), (this.timerCapture = void 0)),
          this
        );
      }),
      (t.prototype.setSourceId = function (e) {
        return (
          (this.videoConstraints.video = e
            ? { optional: [{ sourceId: e }] }
            : !0),
          this
        );
